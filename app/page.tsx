...
function HomeContent() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-white px-6 py-10 text-slate-950">
      <div className="w-full max-w-4xl space-y-8 rounded-2xl border border-slate-200 bg-white px-6 py-8 shadow-lg shadow-slate-200/70">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-widest text-slate-500">
            Nalgo Tube
          </p>
          <h1 className="text-2xl font-bold text-slate-950">영상 검색</h1>
        </div>
        ...
        <section className="rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 py-6 text-sm text-slate-700">
          {loading && <p className="text-center text-slate-500">검색 중...</p>}
...
export default function Home() {
  return (
    <Suspense
      fallback={
        <main className="flex min-h-screen flex-col items-center bg-white px-6 py-10 text-slate-950">
          <div className="w-full max-w-4xl rounded-2xl border border-slate-200 bg-white px-6 py-8 text-center text-sm text-slate-500 shadow-lg shadow-slate-200/70">
            검색 화면을 준비 중...
          </div>
        </main>
      }
